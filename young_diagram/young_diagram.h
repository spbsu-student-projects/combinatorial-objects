...
#ifndef YOUNG_DIAGRAM_H_
#define YOUNG_DIAGRAM_H_
#include "combinatorial_object.h"

class YoungDiagram : public CombinatorialObject
{
	static vector<vector <int64_t> >c;  // binomial coefficients, number of Young diagrams
